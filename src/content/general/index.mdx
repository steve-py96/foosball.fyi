...
You can contribute content and - if you are into it - also code (simply [Markdown] for content and a bit [YAML] for meta-data, more customizations possible 👀).
For more information on how have a look into the [contribution guide].

["let's foos"-app]: https://lets-foos.com/
[GitHub]: https://github.com/
[Markdown]: https://github.github.com/gfm/
[YAML]: https://yaml.org/
[contribution guide]: https://github.com/steve-py96/foosball.fyi/blob/main/CONTRIBUTE.md
